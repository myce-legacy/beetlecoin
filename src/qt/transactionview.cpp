 ...
 */
    ...
    typeWidget->addItem(tr("Received BeetleCoin from zBEET"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBEET"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBEET));
