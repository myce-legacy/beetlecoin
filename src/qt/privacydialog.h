...
public:
    ...
    void setZBeetleCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBEET_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBEET_clicked();
    void on_pushButtonZBeetleCoinControl_clicked();
