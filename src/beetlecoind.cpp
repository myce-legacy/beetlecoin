 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called BeetleCoin (http://www.pivx.org),
 * which enables instant payments to anyone, anywhere in the world. BeetleCoin uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        if (fDaemon) {
            fprintf(stdout, "BeetleCoin server starting\n");
