...
public:
    explicit CZBeetStake(libzerocoin::CoinDenomination denom, const uint256& hashSerial)
    {
        this->denom = denom;
    ...
    explicit CZBeetStake(const libzerocoin::CoinSpend& spend);
    ...
    bool IsZBEET() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZBEET() override { return false; }
};
